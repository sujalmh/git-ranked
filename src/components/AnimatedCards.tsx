...
export function AnimatedCards() {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 relative z-10 w-full">
      ...
      >
        <div className="text-accent font-black text-lg sm:text-2xl tracking-widest uppercase mb-4 sm:mb-6 group-hover:text-white transition-colors">
          Engineering Managers
        </div>
        <h3 className="text-3xl sm:text-5xl md:text-6xl font-black mb-4 sm:mb-8 uppercase leading-[0.95]">
          Find your<br/>true <span className="text-accent">MVPs</span>.
        </h3>
      ...
      >
        <div className="text-white font-black text-lg sm:text-2xl tracking-widest uppercase mb-4 sm:mb-6 group-hover:text-accent transition-colors">
          Developers & Maintainers
        </div>
        <h3 className="text-3xl sm:text-5xl md:text-6xl font-black mb-4 sm:mb-8 uppercase leading-[0.95]">
          Get ranked<br/>for your <span className="text-accent">role</span>.
        </h3>
        <p className="font-medium text-base sm:text-xl leading-relaxed mt-auto text-zinc-300 group-hover:text-white transition-colors">
