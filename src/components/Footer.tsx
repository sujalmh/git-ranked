  ...
  return (
    <footer className="w-full border-t border-white/10 bg-black py-16 px-6 relative z-10">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-10">
        ...
        <div>
          <h3 className="text-sm font-bold uppercase tracking-wider text-[#ccff00] mb-4">Product</h3>
          <ul className="space-y-2.5 text-sm text-zinc-400">
            <li>
        ...
        <div>
          <h3 className="text-sm font-bold uppercase tracking-wider text-[#ccff00] mb-4">Indexing & Resources</h3>
          <ul className="space-y-2.5 text-sm text-zinc-400">
            <li>
      ...
      <div className="max-w-7xl mx-auto border-t border-white/5 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-zinc-600 font-medium">
