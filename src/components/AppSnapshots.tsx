      ...
      <div className="relative rounded-2xl border-2 border-white bg-black overflow-hidden shadow-2xl">
        ...
        <div className="flex items-center justify-between px-4 py-3 bg-zinc-950 border-b border-zinc-800">
          ...
          <div className="flex items-center gap-2 bg-black/90 border border-zinc-800 px-3 py-1 rounded-md text-xs text-zinc-400 font-mono w-full max-w-sm justify-center">
            ...
            <span className="text-accent font-semibold">/repos/facebook/react</span>
          </div>

          <div className="flex items-center gap-2 text-xs text-zinc-500 font-medium">
            <span className="inline-flex items-center gap-1 text-[11px] font-mono text-accent bg-accent/10 px-2 py-0.5 rounded border border-accent/30">
        ...
        <div className="p-4 bg-zinc-950/90 border-b border-zinc-800 space-y-3">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2">
            ...
            <div className="flex items-center gap-2 text-xs">
              ...
              >
                <RefreshCw className="w-3 h-3 text-accent" /> Re-analyse
              </button>
              <button
                type="button"
                className="px-2.5 py-1 bg-zinc-900 border border-zinc-700 text-zinc-300 font-bold text-[10px] uppercase rounded hover:text-white flex items-center gap-1"
              ...
              >
                ...
                <div className="grid grid-cols-3 gap-3 items-end">
                  ...
                  <div className="p-3.5 rounded-xl bg-zinc-950 border-2 border-accent shadow-[0_0_20px_rgba(204,255,0,0.2)] text-center relative space-y-1 scale-105">
                    ...
                    <div className="text-[10px] text-accent font-mono">Generalist</div>
                    <div className="text-base font-black text-accent">
                ...
                <div className="rounded-xl border border-zinc-800 bg-zinc-950 overflow-hidden divide-y divide-zinc-800/80">
                  ...
                  <div className="p-2 flex items-center justify-between text-xs hover:bg-zinc-900/60">
                    ...
                    <span className="font-mono font-bold text-accent">17 / 100</span>
                  </div>
                  ...
                  <div className="p-2 flex items-center justify-between text-xs hover:bg-zinc-900/60">
                    ...
                    <span className="font-mono font-bold text-accent">13 / 100</span>
                  </div>
                </div>
              </motion.div>
            )}
                ...
                <div className="p-4 rounded-xl border border-zinc-800 bg-zinc-950 space-y-3">
                  ...
                  <div className="grid grid-cols-2 gap-3 items-center">
                    ...
                    <div className="space-y-1.5 font-mono text-[10px]">
                      <div>
                        <div className="flex justify-between text-zinc-400"><span>Delivery</span><span className="text-accent font-bold">85</span></div>
                        <div className="w-full bg-zinc-800 h-1 rounded-full"><div className="bg-accent h-full rounded-full" style={{ width: '85%' }} /></div>
                      </div>
                      <div>
                ...
                <div className="p-4 rounded-xl border border-zinc-800 bg-zinc-950 space-y-2.5">
                  ...
                  <div className="space-y-2 text-[11px]">
                    <div className="p-2 rounded border border-zinc-800 bg-black/60 flex items-start gap-2">
                      <div className="w-4 h-4 rounded-full bg-accent/20 text-accent text-[9px] font-bold shrink-0 flex items-center justify-center">s</div>
              ...
              >
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-3 text-xs">
                  ...
                  <div className="p-3.5 rounded-xl border border-zinc-800 bg-zinc-950 space-y-2">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-2">
                        <div className="w-7 h-7 rounded-full bg-accent/20 text-accent font-black flex items-center justify-center text-xs">h</div>
                        <div>
                      ...
                      <span className="text-xs font-black text-accent bg-accent/10 px-2 py-0.5 rounded border border-accent/30">38/100</span>
                    </div>
              ...
              >
                ...
                <div className="p-3.5 sm:p-4 rounded-xl border border-zinc-800 bg-zinc-950 space-y-2.5">
                  ...
                  <div className="grid grid-cols-12 gap-1.5 h-36 font-mono text-[9px] text-white font-bold p-1.5 bg-black rounded-xl border border-zinc-800/90">
                    ...
                    <div className="col-span-3 bg-accent/10 border-2 border-accent/80 p-1.5 rounded-lg flex flex-col justify-between hover:bg-accent/20 transition-colors shadow-[0_0_8px_rgba(204,255,0,0.2)]">
                      <span className="truncate text-accent">Flight</span>
                      <span className="text-[8px] text-accent/80 font-normal">8%</span>
                    </div>
                ...
                <div className="p-4 rounded-xl border border-zinc-800 bg-zinc-950 space-y-2.5">
                  <div className="flex items-center justify-between">
                    <span className="text-xs font-black text-white uppercase flex items-center gap-1.5">
                      <Sparkles className="w-4 h-4 text-accent" /> AI Risk Detection
                    </span>
                    <span className="text-[10px] font-mono text-accent">DISTRIBUTION PATTERNS</span>
                  </div>
          ...
          return (
            <button
              ...
              className={`p-3 text-center rounded-xl border transition-all duration-300 ${
                isActive
                  ? 'bg-zinc-900 border-accent text-white shadow-[0_0_20px_rgba(204,255,0,0.15)] font-bold'
