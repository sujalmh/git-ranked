        ...
        <div className="sleek-panel p-8 sm:p-12 space-y-10 text-zinc-300 leading-relaxed text-base font-medium max-w-5xl">
          <section className="space-y-4">
            <h2 className="text-2xl font-black uppercase tracking-tight text-white flex items-center gap-2">
              <Eye className="w-6 h-6 text-[#ccff00]" /> 1. Overview
            </h2>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-black uppercase tracking-tight text-white flex items-center gap-2">
              <FileText className="w-6 h-6 text-[#ccff00]" /> 2. Information We Collect
            </h2>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-black uppercase tracking-tight text-white flex items-center gap-2">
              <Cookie className="w-6 h-6 text-[#ccff00]" /> 3. Google AdSense & Cookies Policy
            </h2>
            <p>
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li><strong>Opting Out:</strong> Users may opt out of personalized advertising by visiting <a href="https://www.google.com/settings/ads" target="_blank" rel="noopener noreferrer" className="text-[#ccff00] underline">Google Ads Settings</a> or <a href="https://www.aboutads.info" target="_blank" rel="noopener noreferrer" className="text-[#ccff00] underline">aboutads.info</a>.</li>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-black uppercase tracking-tight text-white flex items-center gap-2">
              <Lock className="w-6 h-6 text-[#ccff00]" /> 4. Data Security & Retention
            </h2>
            <p>
          ...
          <section className="space-y-4">
            ...
            <p>
              If you have any questions regarding this Privacy Policy or data requests, please visit our <a href="/contact" className="text-[#ccff00] underline">Contact Page</a>.
            </p>
          </section>
        </div>
      </main>
