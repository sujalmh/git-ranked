        ...
        <div className="sleek-panel p-8 sm:p-12 space-y-10 text-zinc-300 leading-relaxed text-base font-medium max-w-5xl">
          <section className="space-y-4">
            <h2 className="text-2xl font-black uppercase tracking-tight text-white flex items-center gap-2">
              <FileCheck className="w-6 h-6 text-accent" /> 1. Acceptance of Terms
            </h2>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-black uppercase tracking-tight text-white flex items-center gap-2">
              <Shield className="w-6 h-6 text-accent" /> 2. GitHub Integration & Access
            </h2>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-black uppercase tracking-tight text-white flex items-center gap-2">
              <AlertCircle className="w-6 h-6 text-accent" /> 4. Disclaimer of Warranties
            </h2>
            <p>
          ...
          <section className="space-y-4">
            ...
            <p>
              Questions about these Terms should be submitted through our <a href="/contact" className="text-accent font-semibold underline">Contact Page</a>.
            </p>
          </section>
        </div>
      </main>
