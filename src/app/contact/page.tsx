...
export default function ContactPage() {
  const supportEmail = process.env.SUPPORT_EMAIL || 'support@gitranked.dev';
      ...
      <main className="flex-1 w-full px-6 md:px-12 lg:px-16 py-12">
        ...
        <div className="max-w-4xl">
          <div className="sleek-panel p-8 sm:p-12">
            ...
            <form action={`mailto:${supportEmail}`} method="post" encType="text/plain" className="space-y-5">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-white/5 border border-white/10 rounded-lg px-4 py-3 text-sm text-white placeholder:text-zinc-600 focus:outline-none focus:border-accent"
                  />
                </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full bg-white/5 border border-white/10 rounded-lg px-4 py-3 text-sm text-white placeholder:text-zinc-600 focus:outline-none focus:border-accent resize-none"
                ></textarea>
              </div>

              <button
                type="submit"
                className="w-full py-4 bg-accent text-black font-black uppercase tracking-wider hover:bg-white transition-colors flex items-center justify-center gap-2 text-sm"
              >
